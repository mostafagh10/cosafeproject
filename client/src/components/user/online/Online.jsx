...
export default function Online({onlineusers , currentId , setcurrentchat}){
    ...
    useEffect(()=>{
      ...
      const res = await axios.get("https://cosafebackend3.onrender.com/user/admin");
      console.log(res)
      setfriends(res.data)
      };
      getfriends();
    ...
    const handletextsearch = async e => {
      ...
      await axios.get("https://cosafebackend3.onrender.com/user/admin").then((response) => {
    ...
    const handleclick = async (user) => {
      try {
        const res = await axios.get(`https://cosafebackend3.onrender.com/conversations/find/${currentId}/${user._id}`)
